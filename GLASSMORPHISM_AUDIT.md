...
### **Phase 3: Migrate All Components** 📋 PLANNED
...
- **`button`**: Default interactive buttons (`button.primary`)
- **`buttonSecondary`**: Emphasized buttons (`button.secondary`)
- **`buttonAccent`**: CTA/accent buttons (`button.accent`)
