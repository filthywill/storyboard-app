...
import { connectToHeadlessBrowser, scheduleBrowserCleanup, } from "../puppeteer-service.js";
 ...
 */
export function createLighthouseConfig(categories = [AuditCategory.ACCESSIBILITY]) {
    return {
        flags: {
            output: ["json"],
 ...
 */
export async function runLighthouseAudit(url, categories) {
