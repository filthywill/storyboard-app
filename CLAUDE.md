...
- **`docs/architecture/ARCHITECTURE_PRINCIPLES.md`** - Design philosophy and patterns
...
- **`docs/architecture/UI_STATE_HANDLING.md`** - Complete state matrix
...
### Historical Context
- **`docs/bugs-and-fixes/CRITICAL-BUG-REPORT.md`** - Data corruption issues and fixes
- **`docs/sync-and-data/TIMESTAMP_SYNC_IMPLEMENTATION.md`** - Conflict resolution
- **`docs/bugs-and-fixes/DATA_LOSS_FIX_SUMMARY.md`** - Validation layers

### UI Patterns & Styling
- **`docs/styling/SCALING_ALIGNMENT_PATTERNS.md`** - Scaling and alignment patterns
...
2. ✅ Check `docs/architecture/UI_STATE_HANDLING.md` for affected states
