...
**Location:** `/storyboard-app-claude/docs/architecture/ARCHITECTURE_PRINCIPLES.md`
...
**Location:** `/storyboard-app-claude/docs/architecture/UI_STATE_HANDLING.md`
...
### `docs/styling/UNIFIED_COLOR_SYSTEM_IMPLEMENTATION.md`
**Location:** `/storyboard-app-claude/docs/styling/UNIFIED_COLOR_SYSTEM_IMPLEMENTATION.md`
...
**Location:** `/storyboard-app-claude/docs/styling/GLASSMORPHISM_AUDIT.md`
...
See also in `docs/styling/`:
- **COLOR_SYSTEM_COMPREHENSIVE_AUDIT.md** - Comprehensive color audit
- **COLOR_SYSTEM_FULL_AUDIT_2025.md** - 2025 full color audit
...
**Location:** `/storyboard-app-claude/docs/migrations/PHASES_4-6_MIGRATION_SUMMARY.md`
...
See also in `docs/migrations/`:
- **PHASE_1_AND_2_COMPLETE.md** - Phase 1 & 2 completion summary
...
### `docs/setup/SUPABASE_MIGRATION_INSTRUCTIONS.md`
**Location:** `/storyboard-app-claude/docs/setup/SUPABASE_MIGRATION_INSTRUCTIONS.md`

**Purpose:** Instructions for Supabase database setup and migration
...
### `docs/setup/SOCIAL_LOGIN_SETUP.md`
**Location:** `/storyboard-app-claude/docs/setup/SOCIAL_LOGIN_SETUP.md`

**Purpose:** Configuration guide for social authentication providers
...
**Location:** `/storyboard-app-claude/docs/bugs-and-fixes/CRITICAL-BUG-REPORT.md`
...
**Location:** `/storyboard-app-claude/docs/bugs-and-fixes/DATA_LOSS_FIX_SUMMARY.md`
...
**Location:** `/storyboard-app-claude/docs/sync-and-data/TIMESTAMP_SYNC_IMPLEMENTATION.md`
...
**Location:** `/storyboard-app-claude/docs/features/IMAGE_EDITOR_IMPLEMENTATION.md`
...
**Location:** `/storyboard-app-claude/docs/sync-and-data/TESTING_GUIDE_TIMESTAMP_SYNC.md`
...
1. Read: `docs/styling/UNIFIED_COLOR_SYSTEM_IMPLEMENTATION.md` (color system)
...
│   │   ├── SIGNOUT_FLOW_FIX_SUMMARY.md   ← Sign-out fixes
│   │   └── TEST_PLAN_DATA_LOSS_FIX.md    ← Test plans
│   ├── features/
│   │   ├── IMAGE_EDITOR_IMPLEMENTATION.md ← Image editing system
│   │   ├── PDF_PERCENTAGE_FIX.md         ← PDF export fixes
│   │   └── PERCENTAGE_OFFSET_IMPLEMENTATION.md ← Offset system
│   ├── sync-and-data/
...
### When to Update:
- New UI states added → Update `docs/architecture/UI_STATE_HANDLING.md`
- New architecture patterns → Update `docs/architecture/ARCHITECTURE_PRINCIPLES.md`
- New critical rules → Update `.cursorrules`
- New bug discovered → Create new report in `docs/bugs-and-fixes/`
- New features affecting state → Update multiple docs

### Where to Put New Documentation:

**Architecture & Design:**
- `docs/architecture/` - Design principles, patterns, state management

**Bug Reports & Fixes:**
- `docs/bugs-and-fixes/` - Bug reports, post-mortems, fix summaries, test plans

**Feature Documentation:**
- `docs/features/` - Feature implementations, technical specs, how-to guides

**Data & Sync:**
- `docs/sync-and-data/` - Synchronization, offline behavior, database operations

**Component Docs:**
- `docs/component-docs/` - Component-specific docs, FAQs, usage guides

**Maintenance:**
- `docs/maintenance/` - Documentation about documentation (this directory)

**Business:**
- `docs/business/` - Business logic, billing, security, compliance

**Drafts:**
- `docs/drafts/` - Work-in-progress (move to appropriate directory when complete)
...
5. Add entry to `docs/README.md` if major documentation
6. Review related docs for consistency
7. Follow naming convention: `FEATURE_NAME_TYPE.md`

**See:** `docs/maintenance/DOCUMENTATION_MAINTENANCE.md` for detailed guidelines
...
- ✅ Created logical subdirectories (architecture, bugs-and-fixes, features, etc.)
- ✅ Updated all path references throughout documentation
- ✅ Maintained `.cursorrules` at root (required for Cursor AI)
